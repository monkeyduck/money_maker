    ...
    for each_message in jmessage:
        for jdata in each_message['data']:
            ...
            if more == 1:
                ...
                if 0.5 > price_1m_change >= incr_1m_rate and 1.5 > price_5m_change >= incr_5m_rate and 0.3 > price_10s_change >= incr_10s_rate and price_10s_change <= price_1m_change <= price_5m_change:
                    if ind_3s.bid_vol >= vol_3s_bal * ind_3s.ask_vol and ind_1min.bid_vol >= vol_1m_bal * ind_1min.ask_vol and ind_1min.vol > 1.5 * vol_1m_line:
