...
class LeverageAPI(Client):
    ...
    # take order
    def take_order(self, otype, side, instrument_id, size, margin_trading=1, notional='', client_oid='', price='',
                   funds='', order_type=0,):
    ...
    def lever_sell_limit(self, instrument_id, price, amount):
        try:
            if amount > 0:
                # def take_order(self, otype, side, instrument_id, size, margin_trading=1, notional='', client_oid='',
                #               price='', funds='',
